                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-8" style="text-align:center; background-color:rgba(255,255,255,0.8); padding: 10px; border-radius:30px; margin-bottom:20px;">
                            ...
                            <h3 style="padding-bottom: 20px; font-family:gw; text-align:justify;">
                                웨슬리 목사님은 조지아 사바나에서 2년여 동안 선교 사역을 감당했지만 많은 어려움에 부딪힙니다. 웨슬리 목사님은 선교지에서도 엄격한 금욕주의와 영국 교회 중심의 원칙을 지키려 했기 때문에 그 곳에서 일반 성도들의 호감을 얻지 못하였고, 불미스러운 일로 1737년 12월 2일 어려운 마음으로 귀국길에 오르게 되었고, 1738년 2월 1일 고국에 도착하게 됩니다. 웨슬리 목사님 스스로 생각하기에 근본적으로 자신에게 결여되어 있다고 생각했던 것은 바로 "회심"이었습니다.
                            </h3>
                        </div>

                        <div class="col-lg-8">
                            <div class="d-grid gap-2 col-lg-8 mx-auto">
                                <button class="btn btn-secondary next" id="next" type="button" onClick="location.href='/stages/index/quiz-2-2'">다음으로</button>
                            </div>
                        </div>
                    </div>
                </div>
