...
.slider_area {
    background-image: url(<?=base_url('img/game/oldchurch.png')?>);
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-8" style="text-align:center">
                            <h1 style="padding-bottom: 10px;">동대문교회의 시작과 성전건축</h1>
                            <h3 style="padding-bottom: 20px;">아래의 버튼을 누르면 영상을 보실 수 있습니다</h3>
                        </div>
                        <div class="col-lg-8">
                            <div class="d-grid gap-2 col-lg-8 mx-auto">
                                <button type="button" class="cBtnYouTube btn btn-primary" data-bs-toggle="modal" data-bs-target="#oModalYouTube" data-url="https://www.youtube.com/embed/3O7LgNiwe4I?html5=1&autoplay=1" data-titre="볼드윈 시약소와 동대문교회">
                                    볼드윈 시약소와 동대문교회
                                </button>
                                <button type="button" class="cBtnYouTube btn btn-primary" data-bs-toggle="modal" data-bs-target="#oModalYouTube" data-url="https://www.youtube.com/embed/9DKRpKgOoTo?html5=1&autoplay=1" data-titre="새성전 건축">
                                    새성전 건축
                                </button>
                                <button type="button" class="cBtnYouTube btn btn-primary" onClick="location.href='/donghu/index/3'">
                                    나는 동후다
                                </button>
