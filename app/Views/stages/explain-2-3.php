                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-8" style="text-align:center; background-color:rgba(255,255,255,0.8); padding: 10px; border-radius:30px; margin-bottom:20px;">
                            ...
                            <h3 style="padding-bottom: 20px; font-family:gw; text-align:justify;">
                                1738년 5월 24일 저녁 요한 웨슬리는 내적 고민을 거듭하던 끝에 드디어 그가 바라던 구원의 확신을 체험하게 되었습니다. 런던의 올더스케이트 거리에 위치한 어느 작은 기도 모임의 참석은 요한 웨슬레의 장래와 그의 사역 방향을 바꾸어 놓게 되었습니다. 웨슬리 목사님은 그 모임 가운데에서 온전한 회심의 경험을 하게 됩니다. 웨슬리 목사님은 루터의 로마서 주석 서문의 내용을 들으며 회심의 경험을 하게 됩니다.
                            </h3>
                        </div>
