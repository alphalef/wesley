        ...
        <div class="single_slider" style="height: 100vh; background-color: rgba(0,0,0,0.6);">
            <div class="container" id="container">             
                <div class="row align-items-center justify-content-center" style="height: 60vh; z-index:1; margin-top:50px; text-align:center;">
                    <h1 style="text-align:center; color:white;">스크랜톤 선교사님 가족이 한국에서 한 사역은?<br><br>(한칸에 한 글자씩 넣어 주세요)</h1>
                    <form name = "year" style="position:relative; z-index:99;">
                        <div class="input-group justify-content-center">
                            <input type="text" id="a" name="a" class="form-control" style="max-width:50px;" onkeyup='siche_next(this,"학",document.year.b)'>
                            <input type="text" id="b" name="b" class="form-control" style="max-width:50px;" onkeyup='siche_next(this,"교",document.year.c)'>
                            <span class="input-group-text">와</span>
                            <input type="text" id="c" name="c" class="form-control" style="max-width:50px;" onkeyup='siche_next(this,"병",document.year.d)'>
                            <input type="text" id="d" name="d" class="form-control" style="max-width:50px;" onkeyup='siche_next(this,"원",document.year.submit)'>
                        </div>
                        <br><br>
...
<script>
    ...
    function answer() {
        ...
        if(answer.trim() == "학교병원") {
            window.alert('정답입니다!');
            location.href = '/stages/index/2-6';
        } else {
