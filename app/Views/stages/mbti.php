                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-lg-8">
                            <div class="d-grid gap-2 col-lg-8 mx-auto">
                                <button class="btn btn-secondary" type="button" onClick="location.href='https://www.16personalities.com/ko/%EB%AC%B4%EB%A3%8C-%EC%84%B1%EA%B2%A9-%EC%9C%A0%ED%98%95-%EA%B2%80%EC%82%AC'">MBTI 검사하기</button>
                            </div>
                        </div>
                    </div>
                </div>
