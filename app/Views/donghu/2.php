                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-lg-8">
                            <div class="d-grid gap-2 col-lg-8 mx-auto">
                                <button type="button" class="cBtnYouTube btn btn-primary" data-bs-toggle="modal" data-bs-target="#oModalYouTube" data-url="https://www.youtube.com/embed/zIFnP_0uDhs?html5=1&autoplay=1" data-titre="유치부 - 선교사님 얼굴 그리기">
                                    유치부 - 선교사님 얼굴 그리기
                                </button>
                                <button type="button" class="cBtnYouTube btn btn-primary" data-bs-toggle="modal" data-bs-target="#oModalYouTube" data-url="https://www.youtube.com/embed/UpdDiL5sKbo?html5=1&autoplay=1" data-titre="아동부/중고등부 - 4컷 만화 만들기">
                                    아동부/중고등부 - 4컷 만화 만들기
                                </button>
                                <button type="button" class="cBtnYouTube btn btn-primary" data-bs-toggle="modal" data-bs-target="#oModalYouTube" data-url="https://www.youtube.com/embed/zzcdAnTMLa4?html5=1&autoplay=1" data-titre="와서 도우라">
                                    청년부 - 와서 도우라
                                </button>                                
                                  <!-- <button type="button" class="cBtnYouTube btn btn-primary" onClick="alert('준비중입니다')">유치부 - 선교사님 얼굴 그리기</button>
                                  <button type="button" class="cBtnYouTube btn btn-primary" onClick="alert('준비중입니다')">아동부/중고등부 - 4컷 만화 만들기</button>
                                  <button type="button" class="cBtnYouTube btn btn-primary" onClick="alert('준비중입니다')">청년부 - 와서 도우라</button> -->
                            </div>
                        </div>
                    </div>
                </div>
