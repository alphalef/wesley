                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-lg-8">
                            <div class="d-grid gap-2 col-lg-8 mx-auto">
                                <button type="button" class="cBtnYouTube btn btn-primary" data-bs-toggle="modal" data-bs-target="#oModalYouTube" data-url="https://www.youtube.com/embed/o5Zp4ONZ94A?html5=1&autoplay=1" data-titre="동클 - 벙커 선교사님">
                                    동클 - 벙커 선교사님
                                </button>
                                <button type="button" class="cBtnYouTube btn btn-primary" data-bs-toggle="modal" data-bs-target="#oModalYouTube" data-url="https://www.youtube.com/embed/QVfdRC5_xz0?html5=1&autoplay=1" data-titre="동클 - 헐버트 선교사님">
                                    동클 - 헐버트 선교사님
                                </button>                 
