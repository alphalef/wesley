                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col"><a href="/posts/view/<?= $post_item['id'].'-'.$post_item['url'] ?>?no=<?=$n?>&page_group1=<?=$returnPage?>&listcategory=openlist"><?= stripslashes($post_item['title']) ?></a></td>
                                        <?php if($post_item['open'] == 1): ?>
                                            <td scope="col">***</td>
                                        <?php elseif($post_item['open'] == 2): ?>
                                            <td scope="col"><?=$post_item['name']?></td>
                                        <?php endif ?>
                                    </tr>
                                    <?php $n--; ?>
                                    <?php endforeach ?>
